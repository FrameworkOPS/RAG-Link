...
echo ""
echo "NEXT STEPS:"
echo "  1. Add your Fathom API key to:"
echo "     $FRAMEWORK_OPS/fathom/.env  (FATHOM_API_KEY=...)"
echo "  2. Add your Fieldy API key + OpenAI key to:"
echo "     $FRAMEWORK_OPS/fieldy/.env  (FIELDY_API_KEY=... OPENAI_API_KEY=...)"
echo ""
